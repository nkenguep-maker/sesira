...
import { getCustomerList, getOpportunityDetail } from "@/lib/data";
import {
  OPPORTUNITY_STATES,
  ...
  return (
    <>
      <PageHeader
        ...
        title={customerName}
        description="Variantes, révisions, options et décisions autorisées pour ce dossier commercial."
      ...
      <section className="premium-results-section">
        ...
        ) : <p className="premium-muted-copy">Aucune variante de devis n’est enregistrée pour cette opportunité.</p>}
      </section>
...
function transitionActionLabel(state: string) {
  const labels: Record<string, string> = {
    QUALIFYING: "Passer en qualification",
    ACTIVE: "Activer",
    WON: "Marquer gagnée",
    LOST: "Marquer perdue",
    CANCELLED: "Annuler",
