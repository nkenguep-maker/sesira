...
- **HEAD**: `(new)` (C29 maintenance & renewals)
...
| C29 | `(new)` | DONE | Maintenance & renewals (state machine + activate/visit/scan/notice/cancel + 2 read RPCs) — applied on Supabase as `20260923000000`. **WAVE 3 COMPLETE.** |
